...
// AccountUseCase is a mock implementation of usecase.AccountUseCase.
//
// 	func TestSomethingThatUsesAccountUseCase(t *testing.T) {
//
// 		// make and configure a mocked usecase.AccountUseCase
// 		mockedAccountUseCase := &AccountUseCase{
...
// 		}
//
// 		// use mockedAccountUseCase in code that requires usecase.AccountUseCase
...
func (mock *AccountUseCase) CreateAccount(ctx context.Context, input *usecase.AccountInput) (*entities.AccountOutput, error) {
	callInfo := struct {
		Ctx   context.Context
		Input *usecase.AccountInput
	}{
...
func (mock *AccountUseCase) CreateAccountCalls() []struct {
	Ctx   context.Context
	Input *usecase.AccountInput
} {
	var calls []struct {
...
func (mock *AccountUseCase) FetchAccounts(ctx context.Context) ([]entities.AccountOutput, error) {
	callInfo := struct {
		Ctx context.Context
	}{
		Ctx: ctx,
...
func (mock *AccountUseCase) FetchAccountsCalls() []struct {
	Ctx context.Context
} {
	var calls []struct {
		Ctx context.Context
...
func (mock *AccountUseCase) GetBalance(ctx context.Context, id vos.UUID) (int, error) {
	callInfo := struct {
		Ctx context.Context
		ID  vos.UUID
	}{
...
func (mock *AccountUseCase) GetBalanceCalls() []struct {
	Ctx context.Context
	ID  vos.UUID
} {
	var calls []struct {
